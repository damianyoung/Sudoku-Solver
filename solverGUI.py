...
Description: Simple backtracking algorithm implementation
             ...
             with a GUI as a visual representation of this
             algorithm
"""
# solverGUI.py
import pygame
...
class Grid:
    """
    Used to represent and modify given Grid, (Sudoku puzzle)
    ...
    height: height of each row
    win: window size for GUI display

    Methods:
    -------
    update_model()
        Function to update current model
    place()
        Function to place given solution
    sketch()
        Function to insert temporary value chosen by user
    """
    ...
    def update_model(self):
        ...
        Changes model to include items from Square Class.
    ...
    def place(self, val):
        """
        Checks if solution is valid, and inserts solution in space.

        Parameters:
        val: value to be inserted in sudoku square
    ...
    def sketch(self, val):
        """
        Inserts a "sketch" of user selected val.

        Parameters:
        val: value to insert as sketch
    ...
    def draw(self):
        """
        Draws grid lines and individual squares with data from board.
    ...
    def select(self, row, col):
        """
        Selects individual square.

        Parameters:
        row: row to select from board 
        col: column to select from board
    ...
    def click(self, pos):
        """
        Returns clicked square coordinates in board.

        Parameters:
        pos: position of mouse (x,y) format

        Returns:
        (y,x) coordinate, row column
        """
...
def format_time(secs):
    """
    Formats time in the game

    Parameters:
    secs: number of seconds currently passed
